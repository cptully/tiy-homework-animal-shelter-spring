...
public class Animal {
     ...
     */
    public Animal(Integer id, String name, Type type, Breed breed, String color, String description) {
        this.id = id;
        this.name = name;
        this.type = new Type(type.getTypeId(), type.getTypeName());
    ...
    public Animal(String name, Type type, Breed breed, String color, String description) {
        this.name = name;
        this.type = new Type(type.getTypeId(), type.getTypeName());
        this.breed = new Breed(breed.getId(), breed.getName(), breed.getType());
        this.color = color;
    ...
    public void setType(Type type){ this.type = type; }//    void setSpeciesID(Integer speciesID) {this.speciesID = speciesID;}
